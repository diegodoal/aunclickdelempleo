...
public class Template1 {
    ...
    private void addPersonalInformation(PersonalInformation personalInformation) throws DocumentException {
        ...
        document.add(new Paragraph(personalInformation.getBirthDate() + " | " + personalInformation.getAddress() + " | " + personalInformation.getEmail() +" | " + personalInformation.getPhoneNumber()));
    }
