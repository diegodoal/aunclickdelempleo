function deleteExperienceGenerate(){
...
//Pasar a la base de datos
        ...
        url: "/orientation/gettools/cv2/delete" , //direccion del routes al controlador
        contentType: 'application/json'
    }).done(function(result) {
        console.log(result); //Mostrar en la consola el resultado que se ha guardado en la base de datos
        window.location.assign("/orientation/gettools/cv2"); //Redireccionar
    });
